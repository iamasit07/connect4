...
export const GameInfo = () => {
  ...
  return (
    <div className="w-full max-w-[min(90vw,500px)] mx-auto mb-4 space-y-3">
      {/* Spectator badge row */}
      ...
      <div className="flex items-center justify-between gap-4">
        ...
        >
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-xs text-muted-foreground capitalize">{myColor}</p>
          </div>
          {myTurn && !isSpectator && (
            <motion.div
              initial={{ scale: 0 }}
        ...
        <motion.div
          animate={{ 
            ...
            boxShadow: currentTurn !== myPlayer ? '0 0 20px hsl(var(--primary) / 0.3)' : 'none'
          }}
          className={`
            flex-1 flex items-center gap-3 p-3 rounded-xl
        ...
        >
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-xs text-muted-foreground capitalize">{opponentColor}</p>
          </div>
          {currentTurn !== myPlayer && (
            <motion.div
              initial={{ scale: 0 }}
              animate={{ scale: 1 }}
              className="flex items-center gap-1 text-xs sm:text-sm font-medium text-muted-foreground"
            >
              Playing...
            </motion.div>
          )}
