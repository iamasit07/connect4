        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center pt-8">
            {isAuthenticated ? (
              ...
              <>
                <Button size="lg" asChild className="h-14 px-10 text-lg rounded-full shadow-lg hover:shadow-primary/25 transition-all">
                  <Link to="/signup">Start Playing</Link>
                </Button>
                <Button size="lg" variant="ghost" asChild className="h-14 px-10 text-lg rounded-full hover:bg-primary/5">
      ...
      <footer className="border-t border-border/40 py-12">
        <div className="container px-4 flex flex-col md:flex-row justify-between items-center gap-6 text-sm text-muted-foreground">
          ...
          <div className="flex items-center gap-6">
            <a href="https://github.com/iamasit07" target="_blank" rel="noreferrer" className="hover:text-foreground transition-colors">
