...
import type { GameHistoryItem, LiveGame, LeaderboardEntry } from '@/features/game/types';
...
// Hooks
export const useGameHistory = () => useQuery({
...
export const useLiveGames = () => useQuery({
  ...
  queryFn: async () => {
    const { data } = await api.get<LiveGame[]>('/games/live');
    return data;
  },
